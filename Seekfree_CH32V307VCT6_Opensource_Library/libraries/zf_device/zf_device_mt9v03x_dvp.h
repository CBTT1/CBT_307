...
// 配置摄像头参数
#define MT9V03X_DVP_W               186                                             // 图像宽度  范围1-752
#define MT9V03X_DVP_H               86                                             // 图像高度 范围1-480
...
extern volatile uint8    mt9v03x_finish_flag_dvp;//一场图像采集完成标志位
extern uint8    mt9v03x_image_dvp[MT9V03X_DVP_H][MT9V03X_DVP_W];
extern int16 mt9v03x_set_confing_buffer_dvp[CONFIG_FINISH][2];
